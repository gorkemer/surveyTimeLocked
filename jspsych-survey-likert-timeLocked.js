/**
 * jspsych-survey-timeLocked
 * a jspsych plugin for measuring items on a likert scale with a parameter trial_duration added
 *
 * Gorkem Er
 *
...
jsPsych.plugins['survey-likert-timeLocked'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'survey-likert-timeLocked',
    description: '',
    parameters: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // add submit button
    html += '<input type="submit" id="jspsych-survey-likert-next" class="jspsych-survey-likert jspsych-btn" style="visibility:hidden;" value="'+trial.button_label+'"></input>';
    ...
    var all_radio_buttons =  display_element.querySelectorAll('input[type=radio]');

    all_radio_buttons.forEach(function(element) {
